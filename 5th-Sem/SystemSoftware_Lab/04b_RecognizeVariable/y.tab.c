...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from 04bRecognizeVariable.y  */
...
static const char * const yytname[] = {   "$","error","$illegal.","DIGIT","ALPHA",
"var",""
};
#endif
...
#line 13 "04bRecognizeVariable.y"
